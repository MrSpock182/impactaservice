...
public class TestHorario {
    ...
    public void testHorario() {
        try {
            ...
            HorarioRegra horarioRegra = new HorarioRegra("PHPSESSID=rtljmtmm3dmapvu3a4ncfevft0; path=/",
                    "MDE2TVRVeE9EY3lNRGN5TlE9PU16Z3hOQT09",
                    "MDE2TVRVeE9EY3lNRGN5TlE9PU5UYz0=",horarios);
            horarios = horarioRegra.parseHtml();
